...
Additionally, here is a list of Ethereum core developers who may write about security, and see the [bibliography](https://github.com/working-softwareSys/working-software-best-practices#smart-contract-security-bibliography) for more from the community.
